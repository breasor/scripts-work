...
New-Item -ItemType Directory -Path E:\Recovery -Force
Get-BitLockerVolume | Enable-BitLocker -SkipHardwareTest -EncryptionMethod Aes128 -RecoveryKeyPath "E:\Recovery" -RecoveryKeyProtector
